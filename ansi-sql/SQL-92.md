...
SQL-92(공식명: ISO/IEC 9075:1992)는 1992년에 ISO와 IEC에 의해 공식 발표된 SQL 표준의 두 번째 주요 개정판이다. **SQL2**라고도 불리며, 이전 버전인 SQL-86/SQL-89에 비해 기능이 대폭 확장되었다. SQL-92는 약 600페이지에 달하는 방대한 명세로, SQL-89의 약 120페이지에 비해 5배 이상 분량이 증가했다.
