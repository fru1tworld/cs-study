...
SQL:1999(공식명: ISO/IEC 9075:1999)는 SQL 표준의 세 번째 주요 개정판으로, **SQL3**라고도 불린다. SQL-92에서 관계형 모델의 기본 기능을 확립한 이후, SQL:1999는 **객체-관계형(Object-Relational)** 기능을 대폭 추가하며 SQL의 표현력을 획기적으로 확장했다.
