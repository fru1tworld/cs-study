...
이제 결과가 달라집니다. 프레임에 **정확히 2개의 행이 선행하는 것이 아니라 결제 시간보다 2시간 이전**의 모든 행이 포함됩니다. `2005-05-24 22:00:00`의 경우 `2005-05-24 20:00:00`까지의 모든 결제가 포함되지만, 해당 시간대에 결제가 없었기 때문에 `2005-05-24 22:00:00`부터 시작됩니다.
...
- **ROWS**는 정확한 행 개수를 셉니다
- **RANGE**는 값 오프셋을 기준으로 논리적 윈도잉을 수행합니다
- **GROUPS**는 동일한 정렬 값을 가진 행들의 그룹을 셉니다
