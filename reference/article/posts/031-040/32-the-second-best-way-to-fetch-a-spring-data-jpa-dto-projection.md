...
Vlad Mihalcea가 작성한 "[Spring Data JPA DTO 프로젝션을 가져오는 가장 좋은 방법](https://vladmihalcea.com/the-best-way-to-fetch-a-spring-data-jpa-dto-projection/)"이라는 훌륭한 글을 방금 발견했습니다. 이 글은 [reddit](https://www.reddit.com/)에서도 꽤 많은 관심을 받았습니다. 이것은 매우 훌륭한 사용 사례이자 적절한 해결책이라, 이번에는 jOOQ를 사용하여 동일한 작업을 수행하는 **두 번째로 좋은 방법**을 빠르게 보여드리고 싶었습니다.
