...
Vlad Mihalcea는 MongoDB의 집계 파이프라인을 사용하여 무작위 타임스탬프와 float 값을 가진 5천만 건의 레코드를 집계했습니다. 연도와 일수(day-of-year)로 그룹화하면서 count, 평균, 최솟값, 최댓값을 계산했습니다. 이 작업은 **129초**가 걸렸습니다.
