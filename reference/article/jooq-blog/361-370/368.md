...
- **Access, ASE, SQL Server, Sybase**는 DATEPART 함수를 사용합니다
- **DB2**는 Derby와 마찬가지로 함수 기반 접근 방식(YEAR(), MONTH() 등)을 사용합니다
- **Ingres**는 DATE_PART 함수를 사용합니다
- **Oracle**은 jOOQ 3.5에서는 TO_CHAR 함수를 사용했지만, jOOQ 3.6에서는 표준 EXTRACT 구문으로 변경되었습니다
