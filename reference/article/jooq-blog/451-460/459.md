...
1. **Chris Martin**은 Django로 작업하면서 jOOQ가 그리웠다고 표현했습니다: "Django ORM을 쓰다 보니 정말 jOOQ가 그립네요." (2014년 5월 5일)

2. **Moutaz Salem**은 jOOQ를 발견하고 열광적으로 반응했습니다: "#JOOQ 그동안 어디 있었던 거야!" (2014년 4월 28일)

3. **Simon Martinelli**는 Hibernate에서 마이그레이션을 고려했습니다: Hibernate가 지연 로딩을 위해 트랜잭션을 요구하는 것에 의문을 제기하며 jOOQ로의 마이그레이션을 제안했습니다. (2014년 4월 6일)
