...
SQL에 진정으로 필요한 것은 테이블 표현식에 붙일 수 있는 범위 지정(scoped) WITH 절을 사용한 **공통 컬럼 표현식**입니다:
...
SQL 언어가 가장 절실하게 필요로 하는 기능은 바로 **공통 컬럼 표현식**입니다. 이 기능이 있다면 SQL의 고질적인 장황함 문제를 해결하고, 더 간결하고 유지보수하기 쉬운 쿼리를 작성할 수 있을 것입니다.
