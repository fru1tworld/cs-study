...
- **MySQL과 Oracle**이 각각 22%로 공동 1위
- **PostgreSQL과 H2**가 각각 15%로 공동 2위
- **SQL Server**가 10%로 3위
- **HSQLDB**가 7%로 4위
- **DB2, Derby, 기타**가 각각 2%로 공동 5위
- **SQLite, Ingres, Sybase SQL Anywhere, Sybase ASE, CUBRID**가 0%로 공동 6위
