...
그렇습니다! SQL 인젝션에 취약한 코드가 있다면, 공격자는 특정 상황에서 **서버를 장악**할 수 있습니다!! 우리 회사에서는 알려진 취약점이 있는 일부 오픈 소스 블로그 소프트웨어에 대해 샌드박스 환경에서 sqlmap을 시도해 보았습니다. 단 한 줄의 SQL도 작성하지 않고 순식간에 서버를 장악할 수 있었습니다.
