...
├── blog/           # 블로그 글
├── analyses/       # 상세 분석 보고서
├── consistency/    # 일관성 모델 레퍼런스 (jepsen.io/consistency 번역)
└── README.md       # 이 파일
```
...
## 일관성 레퍼런스 (consistency/)

| 파일명 | 내용 |
|--------|------|
| consistency.md | 일관성 메인 페이지 (개요) |
| consistency-models.md | 일관성 모델 16종 (Strict Serializable ~ Read Your Writes) |
| consistency-phenomena.md | 현상 20종 (G0 ~ Lost Write) |
| consistency-dependencies.md | 의존성 5종 (Write-Write ~ Real-time) |
