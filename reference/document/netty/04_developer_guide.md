...
> 이 문서는 Netty 공식 Wiki의 "Developer guide" 페이지를 한국어로 번역한 것입니다.
...
* 단일 라인 변경이나 오타 수정 같은 사소한 기여가 아니라면, [Individual Contributor License Agreement (icla)](http://netty.io/s/icla)를 읽고 서명하거나, 고용주가 [Corporate Contributor License Agreement (ccla)](http://netty.io/s/ccla)에 서명하도록 해주세요.
...
* 작업이 새로운 inspector 경고를 도입하지 않는가?
...
* PR은 종종 여러 커밋을 포함합니다. 그런 커밋들은 설명 주석과 함께 적은 수의 커밋으로 squash해야 합니다.
