...
> 위 수치는 RFC 1122가 아니라 RFC 2236(IGMPv2)에서 정의한 값입니다. RFC 1122는 IGMP 지원 여부만 다루며 구체적인 타이밍 값을 규정하지 않습니다.
...
> RFC 1122가 요구하는 것은 "설정 가능하고 기본값이 2시간 이상인 유휴 시간" 뿐입니다. 프로브 간격(75초)과 재시도 횟수(9회)는 Linux 등 구현체가 정한 기본값이며 RFC 1122의 요구 사항이 아닙니다.
