...
기여한다.
 네트워크 아키텍처의 거의 모든 계층에는 사용될 수 있는
여러 잠재적 프로토콜이 있다.
 예를 들어, 높은 수준에는 원격
...
ether_type$ADDRESS_RESOLUTION인 이더넷 패킷을 생성한다.
 그러면
...
주목하라.
 이것은 다음과 같은 현상의 정당성이다: 만약 호스트 A에서
