...
`testApplication`은 Ktor가 제공하는 in-memory 테스트 하네스임 → 실제 소켓 없이 핸들러를 직접 호출함. 자세한 내용은 [14_testing.md](14_testing.md) 참고.
...
자세한 사용법은 [13_status_pages.md](13_status_pages.md) 참고.
