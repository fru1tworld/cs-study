...
- JVM에서 nullable 참조(`Boolean?`)는 [숫자](numbers.html#boxing-and-caching-numbers-on-the-java-virtual-machine) 처리와 유사하게 Java 클래스로 박싱됨
...
- 자세한 내용은 [반환과 점프](returns.html) 문서 참조
