...
- `Object` 대신 비원시 `object` 타입([TypeScript 2.2에서 추가됨](https://www.typescriptlang.org/docs/handbook/release-notes/typescript-2-2.html#object-type)) 사용
...
- 병합된 멤버의 가시성 규칙은 [네임스페이스 병합](https://www.typescriptlang.org/docs/handbook/declaration-merging.html#merging-namespaces) 섹션에 설명된 것과 동일
