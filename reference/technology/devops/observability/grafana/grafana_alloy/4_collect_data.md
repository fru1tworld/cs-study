# Alloy 데이터 수집: OpenTelemetry, Prometheus, Loki, Pyroscope
...
OTTL(OpenTelemetry Transformation Language)을 사용한 자유로운 변환.
...
otelcol.processor.memory_limiter "default" {
  check_interval         = "1s"
  limit                  = "4000MiB"  // 또는 limit_percentage
  spike_limit            = "800MiB"
