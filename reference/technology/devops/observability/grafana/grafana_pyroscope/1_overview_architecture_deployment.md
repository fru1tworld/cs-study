...
Pyroscope는 다양한 자원 사용 측면을 프로파일링 가능. 자세한 내용은 [04_profile_types.md](./2_profile_types_and_flamegraphs.md) 참조.
...
- [02_architecture.md](./1_overview_architecture_deployment.md) - Pyroscope 아키텍처 상세
- [03_deployment.md](./1_overview_architecture_deployment.md) - 배포 모드 (Monolithic, Microservices)
- [04_profile_types.md](./2_profile_types_and_flamegraphs.md) - 프로파일 타입과 pprof 형식
- [05_flamegraphs.md](./2_profile_types_and_flamegraphs.md) - Flame Graph 분석
- [06_instrumentation.md](./3_instrumentation.md) - 애플리케이션 계측
...
- [03_deployment.md](./1_overview_architecture_deployment.md) - 배포 모드 상세
- [09_configuration.md](./4_manage_use_cases_configuration.md) - 설정 파일 구조
- [07_manage.md](./4_manage_use_cases_configuration.md) - 운영 및 멀티 테넌시 관리
...
- [04_profile_types.md](./2_profile_types_and_flamegraphs.md) - 어떤 프로파일을 보낼지
- [06_instrumentation.md](./3_instrumentation.md) - 클라이언트 계측
- [09_configuration.md](./4_manage_use_cases_configuration.md) - 상세 설정
- [07_manage.md](./4_manage_use_cases_configuration.md) - 운영 모범사례
