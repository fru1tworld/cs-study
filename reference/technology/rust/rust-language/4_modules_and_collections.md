...
표준 라이브러리가 제공하는 다른 종류의 컬렉션에 대한 정보 → [표준 라이브러리 문서](https://doc.rust-lang.org/std/collections/index.html) 참조.
...
사용 가능한 모든 메서드는 [API 문서](https://doc.rust-lang.org/std/vec/struct.Vec.html) 참조.
