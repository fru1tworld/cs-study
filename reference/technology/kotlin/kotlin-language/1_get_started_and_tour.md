...
시작점: [kotlin-tour-hello-world.html](https://kotlinlang.org/docs/kotlin-tour-hello-world.html)
...
시작점: [kotlin-tour-intermediate-extension-functions.html](https://kotlinlang.org/docs/kotlin-tour-intermediate-extension-functions.html)
...
- 다음 주제: [기본 타입](https://kotlinlang.org/docs/kotlin-tour-basic-types.html)
...
[컬렉션](https://kotlinlang.org/docs/kotlin-tour-collections.html)
...
[Kotlin의 클래스](https://kotlinlang.org/docs/kotlin-tour-classes.html)
...
- [null 안전성](https://kotlinlang.org/docs/kotlin-tour-null-safety.html) - Kotlin 투어의 마지막 챕터
...
[제어 흐름](https://kotlinlang.org/docs/kotlin-tour-control-flow.html)
...
Kotlin 학습을 계속:
- [Kotlin 투어](https://kotlinlang.org/docs/kotlin-tour-welcome.html) 참여하기
