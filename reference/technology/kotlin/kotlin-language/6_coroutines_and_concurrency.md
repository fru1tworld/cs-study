...
- 시작하기: 일시 중단 함수·코루틴 빌더·구조적 동시성 등 핵심 개념은 [코루틴 기초](https://kotlinlang.org/docs/coroutines-basics.html) 가이드 참조
...
리소스: [코루틴 기초](https://kotlinlang.org/docs/coroutines-basics.html)와 [일시 중단 함수 합성](https://kotlinlang.org/docs/composing-suspending-functions.html) 참조.
...
- 참고: [코루틴 컨텍스트와 디스패처](https://kotlinlang.org/docs/coroutine-context-and-dispatchers.html), [취소와 타임아웃](https://kotlinlang.org/docs/cancellation-and-timeouts.html), [예외 처리](https://kotlinlang.org/docs/exception-handling.html)
...
리소스: [비동기 Flow](https://kotlinlang.org/docs/flow.html), [채널](https://kotlinlang.org/docs/channels.html), [코루틴과 채널 튜토리얼](https://kotlinlang.org/docs/coroutines-and-channels.html)

---

### 다음 단계 - 학습 경로

1. 기초 — [코루틴 기초 가이드](https://kotlinlang.org/docs/coroutines-basics.html)
2. 고급 합성 — [일시 중단 함수 합성](https://kotlinlang.org/docs/composing-suspending-functions.html)
...
- 이전: [비동기 프로그래밍 기법](https://kotlinlang.org/docs/async-programming.html)
- 다음: [리플렉션](https://kotlinlang.org/docs/reflection.html)
...
### 관련 문서
- [코루틴 참조](https://kotlinlang.org/docs/coroutines-overview.html)
...
관련 주제:
- [코루틴 컨텍스트와 디스패처](https://kotlinlang.org/docs/coroutine-context-and-dispatchers.html)
- [채널](https://kotlinlang.org/docs/channels.html)
...
### 관련 리소스
- [코루틴 기초](https://kotlinlang.org/docs/coroutines-basics.html)
- [취소와 타임아웃](https://kotlinlang.org/docs/cancellation-and-timeouts.html)
