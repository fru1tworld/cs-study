...
- [고차 함수와 람다](https://kotlinlang.org/docs/lambdas.html)
- [클래스](https://kotlinlang.org/docs/classes.html)
- [상속](https://kotlinlang.org/docs/inheritance.html)
- [제네릭](https://kotlinlang.org/docs/generics.html)
...
- [this 표현식](https://kotlinlang.org/docs/lambdas.html)
- [빌더 타입 추론과 함께 빌더 사용](https://kotlinlang.org/docs/lambdas.html)
