...
[Detekt](https://detekt.dev/)는 Arrow를 사용할 때 코드 스타일을 개선하기 위한 **커스텀 규칙 세트**를 제공합니다.
...
[Hoplite](https://github.com/sksamuel/hoplite)는 **다양한 소스, 형식, 그리고 캐스케이딩 설정**을 지원하며 Arrow 타입 디코딩을 지원합니다.
